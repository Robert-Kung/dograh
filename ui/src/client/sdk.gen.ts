 ...
 * Livekit Inbound
 */
export const livekitInboundApiV1LivekitInboundPost = <ThrowOnError extends boolean = false>(options?: Options<LivekitInboundApiV1LivekitInboundPostData, ThrowOnError>) => (options?.client ?? client).post<LivekitInboundApiV1LivekitInboundPostResponses, LivekitInboundApiV1LivekitInboundPostErrors, ThrowOnError>({ url: '/api/v1/livekit/inbound', ...options });
