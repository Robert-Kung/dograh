...
uv pip install -e './pipecat[cartesia,deepgram,openai,elevenlabs,groq,google,azure,sarvam,soundfile,silero,webrtc,livekit,speechmatics,openrouter,camb,mcp,inworld,smallest]'
